  ...
  return (
    <div className="min-h-screen bg-gray-50 p-3 pb-20">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-lg font-bold text-center mb-4 text-gray-800">Invoice Creator</h1>

        {/* Modal */}
        {showModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl max-w-sm w-full p-6 animate-scale">
              <div className="text-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Customer Name Required</h3>
                <p className="text-sm text-gray-600">Please enter a customer name before previewing the invoice.</p>
              </div>
              <button
            ...
            <div className="flex justify-between items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                <input
                  ...
                  placeholder="0"
                  className="w-16 px-2 py-1 text-xs border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 text-right"
                  min="0"
                  max="100"
                  step="0.1"
                />
            ...
            <div className="flex justify-between items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                <input
                  ...
                  placeholder="0"
                  className="w-20 px-2 py-1 text-xs border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 text-right"
                  min="0"
                  step="0.01"
                />
        ...
        <button
          ...
          className="w-full py-3 bg-blue-600 text-white rounded-lg font-semibold text-sm hover:bg-blue-700 active:bg-blue-800 shadow-md"
        >
          Preview Invoice
        </button>
      </div>
